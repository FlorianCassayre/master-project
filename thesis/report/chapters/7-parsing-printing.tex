...
\begin{lstlisting}[language=Scala,caption={[String interpolator unapply]{An example of the possibilities offered by unapply and string interpolators. This is not currently implemented.}},label={lst:string-interpolator-unapply}]
